...
<!-- Further, relative measures are often used: these include context, temporal, and group-specific measures such a certain group should have more access in certain situations. Context-matters, but this presents a challenge in policy planning.
...
<!-- not done-->
The assessment of the effects of policies contextualize in "Who" is the subject of justice, "What" the distribution of transport-related benefits and burdens looks like, "How" these inequities are measured and benchmarked, contextualized in the "Where" across moving "When"s can allow for equity analyses to assist in formulating "Why?" rationales and ultimately towards transport justice. 

Through explicit connections to justice

ecreative methodsinequalities, for 
...
In summary, transportation equity analysis is important. Must be framed and tracked to inform the "Why?" rationale. Standards that results should be flexible to account for the fluidity of justice demands. As Bezo flies, we must interrogate _how_ does he do so -- at who's expense and why is that unfair. The rationale for Why is fundamental to fairness and justice. We must be explicit, intentional and clear in our work in equity analysis and towards implementations that move towards justice.
