...
bibliography: just-transportation/bibliography.bib
---
...
Pflow_chart |>
  ...
  charToRaw() |> rsvg::rsvg_png(file="just-transportation/figures/Pflow_chart.png")
```

```{r import-extraction-data}
Consensus_all <- read_excel("just-transportation/ALL_Extraction_Results_Feb22_edited.xlsx") |> filter(`Reviewer Name` == "Consensus")

Consensus_only_analysis <- read_excel("just-transportation/ALL_Extraction_Results_Feb22_edited.xlsx") |> 
...
# ggsave("just-transportation/figures/standards_conc_percentages_plot.png")
```
...
# ggsave("just-transportation/figures/standards_conc_percentages_plot_and_table.png")
```
...
```{r include=FALSE}
pdftools::pdf_convert('just-transportation/just-transportation.pdf',pages = 1)
```

![The pdf version of this report is available [here](https://github.com/soukhova/Transportation-lit-review/blob/main/just-transportation/just-transportation.pdf)](just-transportation_1.png)
...
![The proportion of equity standards (vertical axis) within each type of equity conceptualization (horizontal axis) category.](just-transportation/figures/standards_conc_percentages_plot_and_table.png)
...
knitr::include_graphics("just-transportation/figures/Methods_framework.png")
```
...
knitr::include_graphics("just-transportation/figures/Pflow_chart.png")
```
...
year_cont_plot
ggsave("just-transportation/figures/year_cont_plot.png")
```
...
pop_plot
ggsave("just-transportation/figures/pop_plot.png")
```
...
mode_plot
ggsave("just-transportation/figures/mode_plot.png")
```
...
knitr::include_graphics("just-transportation/figures/standards_conc_percentages_plot_and_table.png")
```
