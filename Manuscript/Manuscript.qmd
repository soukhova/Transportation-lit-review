...
**NOTE:** After brainstorming, Anastasia, Ignacio, and Antonio suggest that an executive summary could be a good strategy for readers who are too busy to read, and to provide a good idea of what readers who do plan to read will find in this document.
...
_This portion may be helpful to guide readers to desired sections, if they are pressed for time or interested in only particular parts of the report. For instance:_
...
From a modal perspective, transit users are a primary focus of the literature. Upon the rise of automobility, transit came to be seen as a social service and sometimes as a hindrance to the full realization of automobility. After transit users, cyclists and pedestrians are the next most common populations of interest. Historically, walking is how people get around [@robertsShort1998], and cycling and transit use space more efficiently and have relatively low impact, but automobility is in direct tension with other modes as it requires massive amounts of space and receives extraordinary public subsidies, from the way its true cost is systematically underestimated [@gosslingSocial2019] to the way governments support the industries that feed it [@timperleyFight2021]. This may be one reason why transport inequity research focuses on these modes, although often car is the main driver of inequalities in other dimensions (e.g., access/mobility, traffic-related pollution, traffic-safety, and human-health). The focus on active travel and transit is to some extent understandable, given the common but perhaps misleading notion, that travel by car equates privilege. This is, we would argue, a somewhat mypoic omission in the literature reviewed, since it is possible that there are obligated car users who lack other privileges including, for example, people with mobility disabilities [@darcyRoad2018] or the working poor [@blumenbergAutomobile2012]. 
...
## Call 1: The need for explicitly state the conceptual grounding for standards
<!--*And be clear with our terms – what is equity and for whom?**-->
The conceptual grounding for standards is often left implicit within the literature: for example, @muellerSocioeconomicInequalitiesUrban2018 suggests the relative risk of mortality as related to transport-related air pollution should not be higher in deprived groups than the general population. It is not evident from the paper what are the conceptual foundations for this analysis, but we can infer with with some confidence that this is a standard in the service of reparative justice. To move equity analysis outputs towards just transport futures, explicit inclusion of the rationale for justice, the "Why?", should become more common place.
...
We believe that a more robust assessment of the implications of equity standards on the experience of the public is still lacking in the literature and is essential for equity analysis that translate into just practice. While the estimation of the benefits of increased mobility or accessibility, or reducing affordability burdens and transport externalities is commonplace in the literature, these estimations need to be associated with outcomes like life and neighborhood satisfaction, subjective well-being, mental and physical health, social capital, among others. Further, the use of standards that are tangibly linked to outcomes can more concretely define the objects of justice (the "What"). They may also be used to track progress towards justice across time and space.
