...
# The lay of the land: a summary of findings  `r word_comment("NOTE: in this section, only papers that are included in the review (i.e., have a full template) are cited.", "findings")`
...
Of all the studies reviewed, `r (urban_form_count$count[3]/sum(urban_form_count$count)) |> percent()` focus on urban and suburban settings and are highly varied in their research aims. To give an example, @coxQualitativeStudyAccessibility2020 qualitatively examine cycling as a mode of travel for people with disabilities in a typical mid-size town in the UK. @ampeImpactChildBike2020, on the other hand, work to identify the lateral clearance that motorists should maintain when passing cyclists with children seats. While both studies refer to the same objects of justice ("what", i.e., the right to the road and cycling), the subjects of justice (the "who") are different (people with disabilities and children), and the "where", that is, the geographical context for the examination of fairness, differs as well.

The remainder of the studies focus on rural regions (`r (urban_form_count$count[2]/sum(urban_form_count$count)) |> percent()`). To illustrate, we highlight the work of @caoIndicatorsSocioSpatialTransport2017, who examined transportation disadvantage in remote places which rely on inter-island ferry trips in the rural Philippines. Similarly, @parrySocialVulnerabilityClimatic2018 studied remote communities in the Amazonian region, and suggest that "increasing accessibility through road building would be maladaptive, exposing marginalized people to further harm and exacerbating climatic change by driving deforestation" (pp. 125).

## "Who": the subjects of justice

@fig-fig4 showcases the population group types that are the focus of the papers in our review. From this tally, papers that consider income groups is the most widely represented in the literature. Particularly, most papers that focus on income pay usually focus on the lowest-income groups, as they experience the least benefits in terms of mobility and accessibilty, and usually the greatest burdens as well, in terms of cost, exposure, and so on [@peungnumsaiGridBasedSpatialAnalysis2020; @zhaoUnequableSpatialAccessibility2020; @falavignaAssessingInequalitiesPublic2016].
...
# Moving forward: discussion and recommendations
...
## Call 5: Evaluations of interventions and policies
...
<!--
THESE THREE PARAGRAPHS SOUND LIKE A CONCLUSION. PERHAPS A CALL TO ACTION - TO BE ABLE TO MAKE AN INTERNATIONAL COMPARISION ON JUSTICE. WE NEED TO KNOW THE WHY BUT LITERATURE SHOULD START TO OUTLINE THAT EXPLICILITY.
-->
